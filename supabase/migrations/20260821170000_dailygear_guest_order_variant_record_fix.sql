...
-- single atomic checkout path, current variant/parent stock reservation model,
-- catalogue gates, payment-state semantics and order-event writes.
...
begin
  ...
  loop
    ...
    if v_item.variant_id is not null then
      ...
      if v_variant_stock_quantity < v_item.quantity then
        raise exception 'Only % left of %.', v_variant_stock_quantity, v_variant_name;
      end if;
