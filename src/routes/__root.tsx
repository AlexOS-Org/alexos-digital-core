...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AlexOS is an intelligent personal and business operating system for money, sales, goals and operations." },
      ...
      { name: "twitter:description", content: "Your personal & business operating system, powered by AlexOS Intelligence." },
    ],
    links: [
