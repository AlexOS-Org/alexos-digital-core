...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AlexOS Orion is an intelligent personal and business operating system for money, sales, goals and operations." },
      ...
      { property: "og:title", content: "AlexOS Orion — Personal & Business Operating System" },
      { property: "og:description", content: "An intelligent operating system for money, people, goals and business operations." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AlexOS Orion" },
      { name: "twitter:description", content: "Your personal & business operating system, powered by Orion AI." },
    ],
    links: [
...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><ThemeProvider><Outlet /><Toaster /></ThemeProvider></QueryClientProvider>;
}
