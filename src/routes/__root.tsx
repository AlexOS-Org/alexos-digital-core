...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AlexOS is a business operating system powered by Auren Intelligence." },
      ...
      { property: "og:description", content: "A business operating system powered by Auren Intelligence for money, people, goals and operations." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AlexOS" },
      { name: "twitter:description", content: "Your business operating system, powered by Auren Intelligence." },
    ],
    links: [
