  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "[data-hover-expanded=true_&]:mt-0 [data-hover-expanded=true_&]:opacity-100",
        className,
      )}
      {...props}
    />
